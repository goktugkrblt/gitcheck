...
export async function GET(
  ...
  try {
    ...
    // Use score directly from database (always up-to-date after analysis)
...
function generateMinimalistBadge(score: number, rank: number): string {
  return `
<svg width="210" height="38" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 210 38">
  <!-- Background -->
  <rect width="210" height="38" rx="19" fill="#0D1117"/>
  <rect width="210" height="38" rx="19" fill="none" stroke="#30363D" stroke-width="1.5"/>

  <!-- Logo Container -->
  <g>
    <!-- Logo Background Circle -->
    <circle cx="19" cy="19" r="12" fill="#161B22"/>

    <!-- GitCheck Logo SVG Path (properly scaled to fit in 24x24) -->
    <g transform="translate(19, 19) scale(0.088) translate(-122.5, -122.5)">
  ...
  <!-- Rank Text -->
  <text x="37" y="19" font-family="system-ui, -apple-system, sans-serif"
  ...
  <!-- Divider -->
  <rect x="142" y="11" width="1" height="16" fill="#30363D"/>

  <!-- Score Text -->
  <text x="188" y="19" font-family="system-ui, -apple-system, sans-serif"
        font-size="12" font-weight="700" fill="#8B949E"
