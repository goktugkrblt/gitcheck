      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-16">
        ...
        >
          <div className="space-y-8 text-[#919191] leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#e0e0e0] mb-4">Agreement to Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#e0e0e0] mb-4">Description of Service</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#e0e0e0] mb-4">Account Registration and GitHub OAuth</h2>
              
              <h3 className="text-xl font-semibold text-[#e0e0e0] mb-3 mt-6">GitHub Authentication</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-[#e0e0e0] mb-3 mt-6">Account Responsibilities</h3>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#e0e0e0] mb-4">Subscription Plans</h2>
              
              <h3 className="text-xl font-semibold text-[#e0e0e0] mb-3 mt-6">FREE Plan</h3>
              <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <h3 className="text-xl font-semibold text-[#e0e0e0] mb-3 mt-6">PRO Plan ($4.99 one-time)</h3>
              <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <h3 className="text-xl font-semibold text-[#e0e0e0] mb-3 mt-6">Payment Terms</h3>
              <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#e0e0e0] mb-4">Acceptable Use</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#e0e0e0] mb-4">Data Accuracy and Limitations</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#e0e0e0] mb-4">Intellectual Property</h2>
              
              <h3 className="text-xl font-semibold text-[#e0e0e0] mb-3 mt-6">Our Content</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-[#e0e0e0] mb-3 mt-6">Your Data</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-[#e0e0e0] mb-3 mt-6">Generated Reports</h3>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#e0e0e0] mb-4">Service Availability</h2>
              <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#e0e0e0] mb-4">Disclaimer of Warranties</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#e0e0e0] mb-4">Limitation of Liability</h2>
              <p className="uppercase font-bold">
              ...
              <p className="mt-4">
                Our total liability for any claim arising from your use of the Service shall not exceed the amount you paid for PRO access ($4.99) or $100, whichever is greater.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-[#e0e0e0] mb-4">Indemnification</h2>
              <p>
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-[#e0e0e0] mb-3 mt-6">By You</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold text-[#e0e0e0] mb-3 mt-6">By Us</h3>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#e0e0e0] mb-4">Changes to Terms</h2>
              <p>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li><strong>GitHub:</strong> Subject to GitHub's Terms of Service and API guidelines</li>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#e0e0e0] mb-4">Dispute Resolution</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#e0e0e0] mb-4">Severability</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#e0e0e0] mb-4">Entire Agreement</h2>
              <p>
